  ...
  return (
    <>
      <div className="flex items-center justify-center flex-col text-center pt-20 pb-6">
        <h1 className="text-4xl dark:text-white md:text-7xl mb-1 md:mb-3 font-bold">Mahmoud</h1>
        ...
        <p className="text-sm max-w-xl mb-6 font-bold">
          ...
          <a href="http://google.com" target="_blank" className="underline text-red-500" rel="noreferrer noopener">add your website</a>
        </p>
        <p className="text-sm max-w-xl mb-6 font-normal">
          ...
          and non-functional requirements. Enthusiastic web developer with
          commendable background in organising/gathering all necessary tools and
          expertise to design application in line with pre-defined goals.
          Well-versed in providing professional mentorship to software learners.
          Articulate communicator with ability to foster and nurture positive
          and long-term relationships with team members and software developers
          to achieve all pre-defined goals.
        </p>
      </div>
    </>
  );
